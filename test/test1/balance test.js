...
const eth_pool_address = '0x5229897e1b8e7e9dc467a52594a05b28b2c2494f';
...
async function eth_balance(){
    // let web3_instance = new Web3(new Web3.providers.HttpProvider("http://localhost:8545"));
    ...
    console.log(web3_instance.version);
    ...
    for (i =0;;i++) {
        try{
                ...
                while(web3_instance === 'undefined'){
                    ...
                    web3_instance = new Web3("https://ropsten.infura.io/v3/c3436ae558954d85ae242a2ea517475c");
                ...
                console.log(i);
                new_vtx_balance = contract.methods.balanceOf(eth_pool_address).call((err, result) => {console.log(result)}); 
                console.log(await new_vtx_balance);
